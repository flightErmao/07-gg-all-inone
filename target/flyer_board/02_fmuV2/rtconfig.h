...
#define MOTOR_USING_PWM_EN
#define MOTOR_PWM_FREQUENCY 50
#define MOTOR_PWM_CHANNEL_NUM 6
#define MOTOR_PWM_RANGE_MIN 1000
#define MOTOR_PWM_RANGE_MAX 2000
#define MOTOR_USING_PWM_CMD_EN
#define MOTOR_USING_PWM_DEBUGPIN_EN
