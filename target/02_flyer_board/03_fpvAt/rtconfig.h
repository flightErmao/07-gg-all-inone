...
#define PROJECT_BF_WORKQUEUE_RATE_CTRL_STACK_SIZE 1536
#define PROJECT_BF_WORKQUEUE_RATE_CTRL_PRIORITY 4
#define PROJECT_BF_TEST_THREAD_EN
#define PROJECT_BF_TEST_THREAD_STACK_SIZE 2048
#define PROJECT_BF_TEST_THREAD_PRIORITY 6
#define PROJECT_BF_TEST_THREAD_TIMESLICE 5
#define PROJECT_BF_TEST_THREAD_DEBUG_PIN_EN
