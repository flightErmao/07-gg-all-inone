...
#define PROJECT_BF_PID_ANOTC_LOG_ROLL_ANGLE_LOOP_EN
#define PROJECT_BF_PID_ANOTC_LOG_ROLL_ANGLE_LOOP_GROUP 1
#define PROJECT_BF_PID_ANOTC_LOG_ROLL_ANGLE_LOOP_PERIOD_MS 20
