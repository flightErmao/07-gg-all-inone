...
#define PROJECT_MINIFLY_TASK_STABLIZE_LOG_ANGLE_PID_DEBUG
#define PROJECT_MINIFLY_TASK_STABLIZE_LOG_GROUP_ANGLE_PID 4
#define PROJECT_MINIFLY_TASK_STABLIZE_LOG_RATE_PID_DEBUG
#define PROJECT_MINIFLY_TASK_STABLIZE_LOG_GROUP_RATE_PID 5
...
#define PROJECT_MINIFLY_TASK_DSHOT_DEBUG_PIN_EN
#define PROJECT_MINIFLY_TASK_DSHOT_ATKP_LOG_EN
#define PROJECT_MINIFLY_TASK_DSHOT_ATKP_LOG_GROUP 2
