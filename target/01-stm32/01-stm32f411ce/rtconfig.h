...
#define DEMO_TASK_LED
#define TASK_1_LED_BLINK_PRIORITY 5
#define TASK_1_LED_BLINK_TIMER_INTERVAL 100
#define TASK_1_LED_BLINK_PIN "PC13"
#define TOOL_TASK_ANOTC_TELEM_EN
#define TOOL_TASK_DEVICE_DEFAULT "uart2"
#define TOOL_TASK_BAUD_RATE 1000000
#define PROJECT_MINIFLY_SENSOR
#define TASK_SENSOR_MINIFLY_IMU_NAME "mpu6500_minifly"
/* end of L0_TASK_CONFIG */

/* L1_1_MODE_CONFIG */

#define L1_MODULE_LED_BLINK
/* end of L1_1_MODE_CONFIG */
