...
#define WORK_TASK_ESC_MONITOR_EN
#define WORK_TASK_ESC_MONITOR_I2C_NAME "i2c1"
#define WORK_TASK_ESC_MONITOR_I2C_ADDR 0x00
#define WORK_TASK_ESC_MONITOR_MODBUS_REG_INDEX 0
