...
static void delay_ms_pack(uint16_t ms)
{
    rt_thread_mdelay(ms);
}
...
static rt_err_t lowlevel_init(uint8_t id)
{
    ...
    {
#ifdef SENSOR_SPA06_003_NUM1
        spa06_003_num1_.spa06_003.funcRegisterI2c(i2c_read_reg8_one_pack_num1, i2c_wirte_reg8_one_pack_num1, i2c_read_reg8_mult_pack_num1);
    ...
    {
#ifdef SENSOR_SPA06_003_NUM2        
        spa06_003_num2_.spa06_003.funcRegisterI2c(i2c_read_reg8_one_pack_num2, i2c_wirte_reg8_one_pack_num2, i2c_read_reg8_mult_pack_num2);
