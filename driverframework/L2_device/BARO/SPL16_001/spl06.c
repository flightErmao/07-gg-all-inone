	...
	if (p_spl06 == SPL06_NULL) {
		return  E_SPL06_NULL_PTR;
			...
			if (com_rslt == SUCCESS) {
				...
				left = ((int64_t)utemperature<<16);
				REM = (int32_t)(div_s64(left, p_spl06->i32kT));
				fTsc = REM;

				/* Actual temperature should be divided by 256*/
				temperature = ((int32_t)p_spl06->calib_param.c0 << 7) + ((int32_t)((int32_t)p_spl06->calib_param.c1 * fTsc) >> 8);
	...
	if (p_spl06 == SPL06_NULL) {
		...
		if (com_rslt == SUCCESS) {
			left = ((int64_t)utemperature << 16);
				rem = (int32_t)(div_s64( left , p_spl06->i32kT));
				fTsc = rem;
				left = ((int64_t)upressure << 16);
				rem = (int32_t)(div_s64(left , p_spl06->i32kP));
				fPsc = rem;
			
				qua2 = ((int32_t)p_spl06->calib_param.c20 << 8) + ((int32_t)((int32_t)p_spl06->calib_param.c30 * fPsc) >> 8);
				qua3 = ((int32_t)p_spl06->calib_param.c10 << 8) + (int32_t)(((int64_t)qua2 * (int64_t)fPsc) >> 16);
				pressure = ((int32_t)p_spl06->calib_param.c00 << 8) + (int32_t)(((int64_t)qua3 * (int64_t)fPsc) >> 16);
				pressure += ((int32_t)((int32_t)p_spl06->calib_param.c01 * fTsc) >> 8);

				qua2 = ((int32_t)p_spl06->calib_param.c11 << 8) + ((int32_t)((int32_t)p_spl06->calib_param.c21 * fPsc) >> 8);
...
int8_t spl06_get_calib_param(void)
{
	...
	if (p_spl06 == SPL06_NULL) {
		return  E_SPL06_NULL_PTR;
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c0 = (int16_t)a_data_u8r[0]<<4 | a_data_u8r[1]>>4;
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c1 = (int16_t)(a_data_u8r[0]&0x0F)<<8 | a_data_u8r[1];
			...
			&a_data_u8r[2], 1);
			p_spl06->calib_param.c00 = (int32_t)a_data_u8r[0]<<12 | (int32_t)a_data_u8r[1]<<4 | (int32_t)a_data_u8r[2]>>4;
			...
			&a_data_u8r[2], 1);
			p_spl06->calib_param.c10 = (int32_t)(a_data_u8r[0]&0x0F)<<16 | (int32_t)a_data_u8r[1]<<8 | a_data_u8r[2];
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c01 = (int16_t)a_data_u8r[0]<<8 | a_data_u8r[1];
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c11 = (int16_t)a_data_u8r[0]<<8 | a_data_u8r[1];
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c20 = (int16_t)a_data_u8r[0]<<8 | a_data_u8r[1];
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c21 = (int16_t)a_data_u8r[0]<<8 | a_data_u8r[1];
			...
			&a_data_u8r[1], 1);
			p_spl06->calib_param.c30 = (int16_t)a_data_u8r[0]<<8 | a_data_u8r[1];
...
int8_t spl06_set_soft_rst(void)
{
	/* variable used to return communication result*/
	int8_t com_rslt = ERROR;
	uint8_t v_data_u8 = SPL06_SOFT_RESET_CODE;
	/* check the p_spl06 struct pointer as NULL*/
	if (p_spl06 == SPL06_NULL) {
		return  E_SPL06_NULL_PTR;
		} else {
 ...
 *
 */
int8_t spl06_write_register(uint8_t v_addr_u8,
 ...
 *
 */
int8_t spl06_read_register(uint8_t v_addr_u8,
uint8_t *v_data_u8, uint8_t v_len_u8)
{
	/* variable used to return communication result*/
	int8_t com_rslt = ERROR;
...
int64_t spl06_compensate_pressure_int64(void)
{
	...
	if (p_spl06 == SPL06_NULL) {
		return  E_SPL06_NULL_PTR;
			...
			if (com_rslt == SUCCESS) {
				left = (int64_t)utemperature << 16);
				rem = (int64_t)(do_div(left , p_spl06->i32kT));
				fTsc = left;
				left = (int64_t)upressure << 16);
				rem = (int64_t)(do_div(left , p_spl06->i32kP));
				fPsc = left;
			
				qua2 = ((int64_t)p_spl06->calib_param.c20 << 8) + ((int64_t)((int64_t)p_spl06->calib_param.c30 * fPsc) >> 8);
				qua3 = ((int64_t)p_spl06->calib_param.c10 << 8) + (int64_t)(((int64_t)qua2 * (int64_t)fPsc) >> 16);
				pressure = ((int64_t)p_spl06->calib_param.c00 << 8) + (int64_t)(((int64_t)qua3 * (int64_t)fPsc) >> 16);
				pressure += ((int64_t)((int64_t)p_spl06->calib_param.c01 * fTsc) >> 8);

				qua2 = ((int64_t)p_spl06->calib_param.c11 << 8) + ((int64_t)((int64_t)p_spl06->calib_param.c21 * fPsc) >> 8);
				qua3 = (int64_t)(((int64_t)qua2 * (int64_t)fPsc) >> 16);	
				pressure += (int64_t)(((int64_t)qua3 * (int64_t)fTsc) >> 16);
				/* Actual temperature should be divided by 256*/
				pressure = (pressure >> 8);
			}
		}
