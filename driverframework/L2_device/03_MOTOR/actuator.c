...
static rt_ssize_t hal_actuator_read(struct rt_device* dev, rt_off_t pos, void* buffer, rt_size_t size) {
  actuator_dev_t act = (actuator_dev_t)dev;
  rt_size_t rb = 0;
...
static rt_ssize_t hal_actuator_write(rt_device_t dev, rt_off_t pos, const void* buffer, rt_size_t size) {
  actuator_dev_t act = (actuator_dev_t)dev;
  rt_size_t wb = 0;
