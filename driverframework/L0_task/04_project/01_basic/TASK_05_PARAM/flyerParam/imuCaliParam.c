...
static uint8_t imu_cali_orientation;
...
static const uint8_t imu_cali_orientation_default = 0;  // ALIGN_DEFAULT
...
static const param_default_t imu_cali_defaults[] = {
    ...
    {&imu_cali_orientation, &imu_cali_orientation_default},
};
...
static param_list imu_cali_params[] = {
    ...
    {(void *)&imu_cali_orientation, sizeof(imu_cali_orientation), IMU_CALI_PARAM_ORIENTATION, "u8",
     imu_cali_param_default},
};
