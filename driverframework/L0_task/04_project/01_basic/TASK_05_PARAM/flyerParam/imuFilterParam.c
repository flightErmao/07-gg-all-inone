...
static float imu_filter_gyro_cutoff_hz;
...
static const float imu_filter_gyro_cutoff_hz_default = 80.0f;
...
static const param_default_t imu_filter_defaults[] = {
    ...
    {&imu_filter_gyro_cutoff_hz, &imu_filter_gyro_cutoff_hz_default},
...
static param_list imu_filter_params[] = {
    {(void *)&imu_filter_sample_rate_hz, sizeof(imu_filter_sample_rate_hz), "imu_filter_sample_rate_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_gyro_cutoff_hz, sizeof(imu_filter_gyro_cutoff_hz), "imu_filter_gyro_cutoff_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_notch0_freq_hz, sizeof(imu_filter_notch0_freq_hz), "imu_filter_notch0_freq_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_notch0_bw_hz, sizeof(imu_filter_notch0_bw_hz), "imu_filter_notch0_bw_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_notch1_freq_hz, sizeof(imu_filter_notch1_freq_hz), "imu_filter_notch1_freq_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_notch1_bw_hz, sizeof(imu_filter_notch1_bw_hz), "imu_filter_notch1_bw_hz", "f", imu_filter_param_default},
    {(void *)&imu_filter_accel_cutoff_hz, sizeof(imu_filter_accel_cutoff_hz), "imu_filter_accel_cutoff_hz", "f", imu_filter_param_default},
};
