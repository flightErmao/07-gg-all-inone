...
void RcSmoothingFilter::processFilter(const rc_setpoint_msg_t* setpoint_msg, pid_setpoint_msg_t* pid_setpoint_out) {
  ...
  // Copy feedforward values
  std::memcpy(pid_setpoint_out->feedforward, msg_to_use->feedforward, sizeof(msg_to_use->feedforward));
