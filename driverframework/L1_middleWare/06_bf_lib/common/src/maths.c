...
static void buildRotationMatrixLegacy(fp_angles_t *delta, float matrix[3][3])
{
...
void rotateV(struct fp_vector *v, fp_angles_t *delta)
{
    ...
    buildRotationMatrixLegacy(delta, matrix);
...
__attribute__((used)) static void sensorCalibration_SolveLGS(float A[4][4], float x[4], float b[4]) {
    int i;
    float y[4];
