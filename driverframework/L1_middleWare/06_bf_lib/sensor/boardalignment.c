...
{
    if (!boardAlignment || isBoardAlignmentStandard(boardAlignment)) {
    ...
    rotationAngles.angles.roll  = DEGREES_TO_RADIANS((float)boardAlignment->rollDegrees);
    rotationAngles.angles.pitch = DEGREES_TO_RADIANS((float)boardAlignment->pitchDegrees);
    rotationAngles.angles.yaw   = DEGREES_TO_RADIANS((float)boardAlignment->yawDegrees);
