...
void rotation(enum Rotation rotation, float* x, float* y, float* z) {
  ...
  switch (rotation) {
    ...
    case ROTATION_ROLL_90_PITCH_68_YAW_293: {
      ...
      float tmpy = *y;
      float tmpz = *z;
      *x = 0.14303897231223747232853327204793 * tmpx + 0.36877648650320382639478111741482 * tmpy +
           -0.91844638134308709265241077446262 * tmpz;
      *y = -0.33213277779664740485543461545603 * tmpx + -0.85628942146641884303193137384369 * tmpy +
           -0.39554550256296522325882847326284 * tmpz;
      *z = -0.93232380121551217122544130688766 * tmpx + 0.36162457008209242248497616856184 * tmpy +
           0.00000000000000002214311861220361 * tmpz;
      return;
    }
